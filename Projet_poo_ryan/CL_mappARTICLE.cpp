...

{
...

    {
        ...
        return "SELECT id_article, nom_article, design_article, Reaprovisionnement_Articile, id_taux_tva " +
...

    {
        ...
        return "INSERT INTO TB_Article(nom_article, nom_article, Reaprovisionnement_Articile, id_taux_tva) " +
...

    {
        ...
        return "UPDATE TB_Article " +
            ...
            "SET nom_article ='" + this->nom_article + "', design_article ='" + this->design_article + "', Reaprovisionnement_Articile ='" + this->reap_article + "', id_taux_tva ='" + this->id_taux_tva + "' " +
